...
export const metadata = {
  title: "Terms & Conditions | Tranquil",
  description: "Tranquil terms and conditions of use.",
};
          ...
          {[
            {
              ...
              body: "By accessing tranquil.co.in, you agree to these terms. You may not use our site for unlawful purposes or to infringe on the rights of others.",
            },
            {
              title: "Orders & Payments",
              body: "All orders are subject to acceptance and availability. We reserve the right to cancel any order due to pricing errors, fraud, or stock unavailability. UPI payments are verified manually and orders are processed only after successful verification. We do not offer COD.",
            },
            {
              title: "Pricing",
            ...
            {
              title: "Exchanges",
              body: "Size exchanges are offered on a case-by-case basis, subject to stock availability. Items must be unworn, unwashed, with all original tags and packaging intact. The customer is responsible for return shipping costs.",
            },
            {
              title: "Intellectual Property",
              body: "All content on this website including text, images, logos, and designs are the intellectual property of Tranquil and may not be reproduced without written permission.",
            },
            {
              title: "Governing Law",
