    ...
    <div className="bg-[#FAF8F5] min-h-screen pt-32 pb-24">
      <div className="container mx-auto px-6 lg:px-12 max-w-3xl">
        <p className="text-xs text-[#666666] uppercase tracking-widest mb-4">
          <Link href="/" className="hover:text-[#C7A17A]">Home</Link> / Exchange Policy
        </p>
        <h1 className="font-serif text-5xl text-[#111111] mb-4">Exchange Policy</h1>
        ...
        <div className="mt-12 border-t border-[#EFEFEF] pt-8 text-center">
          <p className="text-[#666666] text-sm mb-4">Have a question about your order?</p>
          <a
