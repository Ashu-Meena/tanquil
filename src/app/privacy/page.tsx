  ...
  return (
    <div className="bg-white min-h-screen pt-32 pb-24">
      <div className="container mx-auto px-6 lg:px-12 max-w-3xl">
        <p className="text-xs text-[#666666] uppercase tracking-widest mb-4"><Link href="/" className="hover:text-[#C7A17A]">Home</Link> / Privacy</p>
        <h1 className="font-serif text-5xl text-[#111111] mb-4">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-[#555555] leading-relaxed prose prose-sm max-w-none">
          <section>
            <h2 className="font-serif text-2xl text-[#111111] mb-3">Information We Collect</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl text-[#111111] mb-3">How We Use Your Information</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl text-[#111111] mb-3">Data Security</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl text-[#111111] mb-3">Contact</h2>
            <p>For privacy concerns, write to us at <a href="mailto:privacy@tranquil.co.in" className="text-[#C7A17A] hover:underline">privacy@tranquil.co.in</a>.</p>
          </section>
        </div>
      </div>
    </div>
